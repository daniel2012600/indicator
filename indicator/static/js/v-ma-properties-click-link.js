...
Vue.component("v-ma-properties-click-link", {
    delimiters: ['[[', ']]'],
    ...
    <el-form ref="click-link" :model="form_data" label-position="top"　label-width="70px" :rules="rules" @submit.native.prevent>
        <!--<el-form-item label="會員有點擊此連結" prop="url_link">
            <el-input
                type="textarea"
